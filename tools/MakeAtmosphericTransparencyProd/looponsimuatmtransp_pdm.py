####################################################################################################################
# python looponsimuatmtransp_pdm.py -f 6 -l 14
#
#- author : Sylvie Dagoret-Campagne
#- affiliation : IJCLab/CNRS/IN2P3
#- creation date: September 25th 2020
#
# Simulate air transparency for Pic Du Midi
#
####################################################################################################################
...
if __name__ == "__main__":
    ...
    with contextlib.redirect_stdout(None):
        for idx in np.arange(IDX_START, IDX_STOP + 1):
            cmd = f"python simulateatmtransparency_pdm.py --config config/picdumidi.ini -n {idx}"
            logger.info(cmd)
            os.system(cmd)
